/*************************************************************************************************
 *
 * angular-pane-manager - a port of ng-pane-manager to Angular 2+ (ng-pane-title.component.spec.ts)
...
describe('NgPaneTitleComponent', () => {
    ...
    beforeEach(async(() => {
        void TestBed.configureTestingModule({declarations: [NgPaneTitleComponent]})
            .compileComponents();
    }));
