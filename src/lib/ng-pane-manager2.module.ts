/**************************************************************************************
 *
 * ng-pane-manager2 - a fork of ng-pane-manager for Angular (ng-pane-manager2.module.ts)
...
@NgModule(
    {declarations: [NgPaneManager2Component], imports: [], exports: [NgPaneManager2Component]})
